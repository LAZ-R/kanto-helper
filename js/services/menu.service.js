...
export const ENTRIES = [
  ...
  { id: 'pokedex',             route: '/pokedex',             label: 'Pokédex',              iconName: 'database',         primary: true, },
  { id: 'guide',               route: '/guide',               label: 'Guide',                iconName: 'circle-info',      primary: true, },
  { id: 'map',                 route: '/map',                 label: 'Carte',                iconName: 'map-location-dot', primary: true, },
  // SECONDARY
  { id: 'types-table',         route: '/types-table',         label: 'Table des Types',      iconName: 'table-cells',      primary: false, },
  { id: 'glitches',            route: '/glitches',            label: 'Glitches',             iconName: 'exclamation',      primary: false, },
  { id: 'who-is-that-pokemon', route: '/who-is-that-pokemon', label: 'Qui est ce Pokémon ?', iconName: 'circle-question',  primary: false, },
  // SETTINGS
