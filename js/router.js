...
const routes = {
  ...
  '/pokedex':             () => import('./views/pokedex/pokedex.view.js'),
  '/pokedex/pokemon':     () => import('./views/pokemon/pokemon.view.js'),
  '/guide':               () => import('./views/guide/guide.view.js'),
  '/map':                 () => import('./views/map/map.view.js'),
  '/types-table':         () => import('./views/types-table/types-table.view.js'),
  '/glitches':            () => import('./views/glitches/glitches.view.js'),
  '/who-is-that-pokemon': () => import('./views/who-is-that-pokemon/who-is-that-pokemon.view.js'),
